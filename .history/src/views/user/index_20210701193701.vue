 ...
 <div class="app-container">
    <el-table stripe border :data="list" style="width:100%">
      ...
      <el-table-column label="头像" width="130">
        <template slot-scope="scope">
          <img :src="scope.row.avatar | dalImg" style="max-width:120px;max-height:120px;diaplay:block;magin:0 auto;" alt="" />
          </template>
          </el-table-column>
...
>
  ...
  <el-table :data="gridData">
    ...
    <el-table-column width="100" property="product.name" label="姓名"></el-table-column>
    <el-table-column width="100" property="amount" label="数量"></el-table-column>
    <el-table-column width="100" property="product.amount" label="库存"></el-table-column>
    <el-table-column label="图片" width="130">
        <template slot-scope="scope">
          <img :src="scope.row.product.coverImage | dalImg" style="max-width:120px;max-height:120px;diaplay:block;magin:0 auto;" alt="" />
          </template>
          </el-table-column>
  </el-table>

  <el-button class="button" type="danger" slot="reference" icon="el-icon-shopping-cart-1
" size="small" @click="loadData()" circle style="background:deeppink"></el-button>
</el-popover>
...
export default {
  ...
  methods: {
    ...
    async loadData(page = 1, id) {
      ...
      const res = await CloadUsersApi(id)
      console.log(id)
      console.log(res)
      console.log(data)
      this.list = data.data
