    ...
    <el-table stripe border :data="list" style="width:100%">
      ...
      <el-table-column label="头像" width="130">
        ...
        <el-table-column label="操作" width="200">
          <template slot-scope="scope">
            <el-button icon="el-icon-lock" size="small" type="primary" @click="editOne(scope.row)" circle></el-button>
            
                
<el-popconfirm
  title="确认删除此项？" @onConfirm="delOne(scope.row)"
>
  <el-button type="danger" slot="reference" icon="el-icon-delete" size="small" circle ></el-button>
</el-popconfirm>

            <el-button type="danger" slot="reference" icon="el-icon-shopping-cart-1
" size="small" circle style="background:deeppink"></el-button>

           <el-button type="warning" slot="reference" icon="el-icon-present
