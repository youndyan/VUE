...
>
  ...
  <el-table :data="gridData">
    <el-table-column width="150" property="date" label="序号"></el-table-column>
    <el-table-column width="150" property="date" label="价格"></el-table-column>
    <el-table-column width="100" property="name" label="姓名"></el-table-column>
    <el-table-column width="300" property="address" label="数量"></el-table-column>
  </el-table>
