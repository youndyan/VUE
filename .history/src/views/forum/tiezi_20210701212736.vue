...
<el-table-column label="用户名" prop="user.userName" />
      ...
      <el-table-column label="用户头像" width="130">
        <template slot-scope="scope">
          <img :src="scope.row.user.avatar | dalImg" style="max-width:120px;max-height:120px;diaplay:block;magin:0 auto;" alt="" />
          </template>
          </el-table-column>
...
<el-popconfirm @onConfirm="delOne(scope.row)"
>
  <el-button slot="reference" icon="el-icon-delete" size="small" >评论管理</el-button>
</el-popconfirm>
