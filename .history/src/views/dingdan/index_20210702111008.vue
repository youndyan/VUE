  ...
  <div class="app-container">
    <el-table stripe border :data="list" style="width:100%">
      ...
      <el-table-column label="用户名" prop="userName" />
       <el-table-column label="价格" prop="userName" />
       <el-table-column label="地址" prop="userName" />
       <el-table-column label="详细地址" prop="userName" />
       <el-table-column label="订单状态" prop="userName" />
       <el-table-column label="支付状态" prop="userName" />
...
<script>
import { DoadUsersApi, deleteOneApi } from '@/api/dingdan'
export default {
  name: 'UserList',
  data() {
    return {
