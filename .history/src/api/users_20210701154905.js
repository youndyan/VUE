...
export const CartUsersApi = (page = 1) => get('/api/v1/admin/cart/info', { page })
// 新增
// export const insertUsersApi = data => post('/api/v1/admin/cart/info', data)

export const deleteOneApi = id => del(`/api/v1/admin/cart/info/${id}`)

export const editOneApi = (id, data) => put(`/api/v1/admin/cart/info/${id}`, data)

// 根据id获取单条数据
export const getOneByIdApi = id => get(`/api/v1/admin/cart/info/${id}`)
